...
function DeployDiagram() {
  return (
    <svg viewBox="0 0 560 300" className="w-full" role="img" aria-label="教学改进关系示意：学校目标连接教师重点与学生行动，持续复盘">
      <rect x="30" y="34" width="500" height="224" rx="18" fill="#0a1f1d" />
      <text x="280" y="68" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="12">学校的教学现场</text>
      <rect x="62" y="100" width="124" height="72" rx="12" fill="#0d2a27" stroke="rgba(94,234,212,0.45)" />
      <text x="124" y="132" textAnchor="middle" fill="#5eead4" fontSize="14" fontWeight="600">学校目标</text>
      <text x="124" y="153" textAnchor="middle" fill="rgba(255,255,255,0.45)" fontSize="11">看见变化</text>
      <rect x="218" y="100" width="124" height="72" rx="12" fill="#0d2a27" stroke="rgba(94,234,212,0.45)" />
      <text x="280" y="132" textAnchor="middle" fill="#5eead4" fontSize="14" fontWeight="600">教师重点</text>
      <text x="280" y="153" textAnchor="middle" fill="rgba(255,255,255,0.45)" fontSize="11">决定先改什么</text>
      <rect x="374" y="100" width="124" height="72" rx="12" fill="#0d2a27" stroke="rgba(245,176,77,0.55)" />
      <text x="436" y="132" textAnchor="middle" fill="#f5b04d" fontSize="14" fontWeight="600">学生行动</text>
      ...
      <path d="M436 182 C436 218, 124 218, 124 182" fill="none" stroke="#5eead4" strokeOpacity="0.55" strokeDasharray="5 4" />
      ...
      <section className="border-y border-line bg-surface py-20 md:py-24">
        <Container className="grid items-center gap-10 lg:grid-cols-[1fr_1.1fr]">
          <Reveal>
            ...
            />
            <p className="mt-6 rounded-xl border border-line bg-paper p-4 text-sm leading-relaxed text-ink-soft">
              我们会结合学校的实际场景说明使用方式，让管理者、老师和学生都能从第一天顺利接上。
            </p>
          </Reveal>
          <Reveal delay={0.1} className="rounded-2xl border border-line bg-paper p-4 md:p-6">
            <DeployDiagram />
          </Reveal>
        </Container>
      </section>
